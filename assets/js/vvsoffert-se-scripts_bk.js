$(function() {
	...
	$('#vvsoffert-se-search').click(function(e) {
		...
		if(currentUrl == 'http://localhost/vvsoffert.se/' || currentUrl == 'https://vvsoffert.se/') {

			seachUrl = currentUrl + 'Products?search=' + key.trim();
			
		} else if(currentUrl.search('search') > 0) {

			var urlArr = currentUrl.split('?');

			seachUrl = urlArr[0] + '?search=' + key;

		} else {

			seachUrl = currentUrl + '?search=' + key;
	...
	$('#m-vvsoffert-se-search').click(function(e) {
		...
		if(currentUrl == 'http://localhost/vvsoffert.se/' || currentUrl == 'https://vvsoffert.se/') {
			...
			seachUrl = currentUrl + 'Products?search=' + key;
