                    ...
                    <div class="col-md-12 hidden-lg hidden-md hidden-sm">
                        <nav class="navbar" id="topbar-wrapper" role="navigation">
                            ...
                            <div style="width: 20%; text-align: right; float: right;text-align: left;">
                                <a class="btn btn-success" href="" id="m-vvsoffert-se-search" style="padding: 9px 10px;"><i class="fa fa-search"></i>Sök</a>
                            </div>
                        </nav>
                    </div>
...
<?php
                    ...
                    <div class="col-md-4 hidden-xs" style="text-align: right;">
                        <nav class="navbar" id="topbar-wrapper" role="navigation">
                            ...
                            <div style="width: 20%; text-align: right; float: right;text-align: left;">
                                <a class="btn btn-success" href="" id="vvsoffert-se-search" style="padding: 9px 12px;"><i class="fa fa-search"></i>Sök</a>
                            </div>
                        </nav>
                    </div>
