                        ...
                        <div class="pull-right" id="myTopNavbar">
                            <nav class="navbar" id="topbar-wrapper" role="navigation">
                                <ul class="nav topbar-nav">
                                    ...
                                    <!--<li><a href="<?php echo site_url('Products'); ?>"><i class="fab fa-product-hunt"></i> Produkter</a></li>-->
                                                                        <li class="dropdown">
                                                                            <a data-toggle="dropdown" class="dropdown-toggle" href="<?php echo site_url('Products'); ?>"><i class="fab fa-product-hunt"></i> Produkter <b class="caret"></b></a>
                                                                            <?php
                                                                                        ...
                                                                                        if(count($sub_category1_list)>0) {
                                                                                            ...
                                                                                            foreach($sub_category1_list as $sub_category1) {
                                                                                                ...
                                                                                                if(count($sub_category2_list)>0) {
                                                                                                    echo '<ul class="dropdown-menu third-menu">';
