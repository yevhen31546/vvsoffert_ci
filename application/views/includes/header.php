...
<html lang="en">
    <head>
        <meta name="ahrefs-site-verification" content="b2b5f9773572604b6449124d1b8fbee3bef2642e391d200cec55d19cedf87e91">
...
<!--</script>-->
        ...
        <?php if(($_SERVER['REQUEST_URI']=='/')||($_SERVER['REQUEST_URI']=='')||($_SERVER['REQUEST_URI']=='/index.php')||($_SERVER['REQUEST_URI']=='/index.html')){ ?>
            <title>Gratis VVS offerter på vvs produkter|vvsoffert.se</title>
            <meta content="På vvsoffert.se får du hjälp att få en snabb vvs offert utan kostnad. Fyll i vad du vill ha hjälp med och få offerter på Varmvattenberedare till golvärme.." name="description">
        <?php } else { ?>
            <title>Gratis VVS offerter på vvs produkter|vvsoffert.se </title>
            <meta content="<?php echo str_replace("index.php","",str_replace("/product/","",$_SERVER['REQUEST_URI'])); ?>" name="description">
        <?php } ?>
        <meta content="På vvsoffert.se får du hjälp att få en snabb vvs offert utan kostnad. Fyll i vad du vill ha hjälp med och få offerter på Varmvattenberedare till golvärme" name="keywords">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <?php if(($_SERVER['REQUEST_URI']=='/')||($_SERVER['REQUEST_URI']=='')||($_SERVER['REQUEST_URI']=='/index.php')||($_SERVER['REQUEST_URI']=='/index.html')){ ?>
        <link rel="canonical" href="https://vvsoffert.se" />
        <?php } else { ?>
        ...
        <link rel="stylesheet" type="text/css" href="//cdn.datatables.net/buttons/1.5.4/css/buttons.dataTables.min.css">
        <link rel="stylesheet" type="text/css" href="//cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.7.1/css/bootstrap-datepicker3.css">
...
.gallery_tabs .change_tab_text{box-shadow:0px 1px 5px 1px #ccc;padding:20px;margin:30px 11px;font-family:Myriad-Pro;font-weight:normal;color:#929292}
...
.dashbaord{font-family:Myriad-Pro;width:100%;}
/*@media(min-width:1440px){.col-sm-3{width: 350px;}*/
.dashbaord .dashbaord_nav{border-left:1px solid #ebebeb;border-right:1px solid #ebebeb;box-shadow:0px 1px 8px -2px #ccc;min-height:70em;padding: 10px 0;border-radius: 5px;}
.dashbaord .dashbaord_nav ul{padding:10px 0px}
.dashbaord .dashbaord_nav ul li a{margin:0px 0px;font-size:18px;color:black;display:inline-block;width:100%;padding:14px}
.dashbaord .dashbaord_nav ul li a:hover{background: #f6f6f6;}
.dashbaord .dashbaord_nav ul li a .fa{padding-right:4px}
.dashbaord .dashbaord_nav ul li a:hover{text-decoration:none; font-size: 20px;box-shadow: 0px 1px 3px darkgrey; border-left: 6px solid #2ca01c;}
.dashbaord .dashbaord_nav ul li a:hover :child{display: none}
...
.overall_content .section_content .table th{color:#838383;font-size:20px;padding:14px 2px;border-top:2px solid #ddd !important;}
.overall_content .section_content .table td{font-size:20px;padding:10px 0;line-height:30px;color:#838383}
.overall_content .section_content .option_btn{padding-top:3px !important}
.dashbaord .table_content .table_header{color:#606060;font-size:18px;padding:16px 0;padding-top:20px}
.dashbaord .overall_content{}
...
.dashbaord .dashbaord_nav .active{text-decoration:none;background:#f6f6f6;border-left: 6px solid #2ca01c; font-size: 20px; box-shadow: 1px 2px 5px darkgrey;}
...
#datatable_wrapper input{font-size: 16px; height: 35px;}
#datatable_wrapper .input-sm{font-size: 16px; height: 35px;}
#datatable_wrapper .row{margin:0;}
...
.signup_screen .signup_form .form-group .form-control{height:48px;font-size:18px}
.signup_screen{max-width:550px;margin:60px auto;background:#fafdff;padding:20px;box-shadow:0px 2px 20px 0px #ddd;font-family:Myriad-Pro;border-top:5px solid #1e9f2e;border-left:1px solid #ddd;border-right:1px solid #ddd;border-bottom:1px solid #ddd}
...
.site_footer{background:#18435f;padding:0pt 0;text-align:center;font-family:Myriad-Pro;float:left;width:100%;}
.site_footer .links li a{color:#fff;font-size:16px}
.site_footer .coppyright{text-align:center;padding-top:0px;font-size:16px;color:#fff}
@media (min-width:1025px) and (max-width:1200px){}
@media (min-width:768px) and (max-width:1025px){.gallery_tabs .radius_img{height:140PX;width:140PX;}
...
.dashbaord .section_content table{padding:4px 10px;}
.overall_content .section_content .table td{padding:10px 16px !important;font-size:14px !important}
.overall_content .section_content .table th{padding:14px 20px !important; font-size:16px !important}
...
span span { margin-left : 0px !important;}
legend data-i18n 
...
.dashbaord .section_content table {
    padding: 4px 10px;
    display: grid ;
}
}
        ...
        <div class="container-fluid header_bg">
            <div class="container header nopad-hd-lft-rgt">
                <div class="navigation">
                    <div class="pull-left col-md-3"><a href="<?= site_url()?>"><img src="<?= site_url() ?>assets/img/logo.png" class="img-responsive" alt="Vvs offert | Rörkalkyl | Vvskalkyl | Anbud | Vvspriser |Vvsoffert | Vvs online | Rörgrossist" width="224" height="40"></a></div>
                    <div class="pull-right col-md-9 hidden-xs">
                        <h1 style="font-family: Myriad-Pro; color: #fff; padding: 0px; margin-top: 0px; margin-bottom: 30px; font-size: 32px!important;">Jämför vvsartiklar, pris, lagersaldo från grossister. <a href="<?php echo site_url('registrera'); ?>" style="display: initial; background-color: #1e9f2e; color: #ffffff; font-size: 70%;" class="btn btn-sm">Prova Gratis <i class="fa fa-forward"></i></a></h1>
                    </div>
                            ...
                            <nav class="navbar" id="sidebar-wrapper" role="navigation">
                                <ul class="nav sidebar-nav menu-items">
                                    <li><a href="<?php echo site_url(); ?>"><i class="fa fa-home"></i> Hem</a></li>
                                                                        <li class="dropdown">
                                                                            <a class="has-dropdown" href="#"><i class="fab fa-product-hunt"></i> Produkter</a>
                                                                            <?php
                                    ...
                                    <li><a href="<?php echo site_url('priser'); ?>"><i class="fa fa-money-bill-alt"></i> Priser</a></li>
                                    <li><a href="<?php echo site_url('nyheter'); ?>"><i class="fa fa-newspaper"></i> Nyheter</a></li>
                                    <li><a href="<?php echo site_url('kontakta-oss'); ?>"><i class="fa fa-envelope-open"></i> Kontakta Oss</a></li>
                                    <?php if (!$this->session->userdata('user_id')) { ?>
                                        <li><a href="<?php echo site_url('logga-in'); ?>"><i class="fa fa-sign-in-alt"></i> Logga In</a></li>
                                        <li><a href="<?php echo site_url('registrera'); ?>" style="background-color: #1e9f2e; color: #ffffff;" class=""><i class="fa fa-angle-double-right"></i> Prova Gratis</a></li>
                                        
                                    <?php } else { ?>
                                        <li><a href="<?php echo site_url('kontrollpanel'); ?>"><i class="fas fa-tachometer-alt"></i> Kontrollpanel</a></li>
                                        <li><a href="<?php echo site_url('logga-out'); ?>"><i class="fas fa-sign-out-alt"></i> Logga Out</a></li>
                                    <?php } ?>
                                </ul>
                            </nav>
                        </div>
                    ...
                    <div class="col-md-12 hidden-lg hidden-md hidden-sm">
                        <nav class="navbar" id="topbar-wrapper" role="navigation">
                            ...
                            <div style="width: 20%; text-align: right; float: right;text-align: left;">
                                <!--for mobile-->
                                <a class="btn btn-success" href="" id="m-vvsoffert-se-search" style="padding: 9px 10px; background: #1e9f2e;"><i class="fa fa-search"></i>Sök</a>
                            </div>
                        </nav>
                    </div>
                    <div class="col-md-2 pull-left hidden-xs">
                        <ul class="nav topbar-nav">
                            <li class="dropdown" id="product-menu-link"><a id="product-root" href="#"><i class="fab fa-product-hunt"></i> Produkter <b class="caret"></b></a>
<?php
                                                                                $custom_helper = get_instance()->load->helper('custom');
                                                                                $main_category_list = getListdata(array('pid'=>NULL,'pid2'=>NULL),'categories','name','ASC');   
                                                                                    
                                                                                if(count($main_category_list)>0) {
                                                                                    echo '<ul id="product-menu" class="dropdown-menu main-product-category list-group">';
                                                                                    foreach($main_category_list as $main_category) {
                    ...
                    <div class="col-md-4 hidden-xs" style="text-align: right;">
                        <nav class="navbar" id="topbar-wrapper" role="navigation">
                            <div style="width: 80%; float: left;">
                                <input type="text" id="search-key" name="search-key" style="width: 100%; height: 40px; padding:  6px 12px; font-size: 16px; color: #363636; background: #dcdfea; border-radius: 5px;" placeholder="Vad söker du?" autocomplete="off" />
                            </div>
                            <div style="width: 20%; text-align: right; float: right;text-align: left;">
                                <!--for pc-->
                                <a class="btn btn-success" href="" id="vvsoffert-se-search" style="padding: 9px 12px; background: #1e9f2e;"><i class="fa fa-search"></i>Sök</a>
                            </div>
                        </nav>
                    </div>
