<div class="site_footer">
        <ul class="links list-inline">
            ...
            <li><a href="<?=site_url('Products')?>">Produkt &nbsp;&nbsp;|</a></li>
             <li><a href="<?=site_url('terms-condition')?>">Villkor & Betingelser</a></li>
        </ul>
    ...
    //            }
        ...
        function InsertInSelectedIDs(id){
            ...
            if(new_ids){
                ...
                $('#selected_pros').append('<li id="pro_'+id+'"> '+ name +'     <p class="fa fa-times" onClick="removeProduct('+id+')"></p></li>');
