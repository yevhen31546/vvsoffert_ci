...
<div class="admin-content">
    <div class="container">
        ...
        <div class="box">
            <div class="box-inner"> 
                <form id="import_products_file_form" name="import_products_file_form" method="post" action="<?php echo site_url('admin/products/import_product'); ?>" enctype="multipart/form-data">
                    <div class="box-title">
                        ...
                        <div class="pull-right">
                            <label class="form-check-label">
                                ...
                                <a href="<?php echo base_url() . 'uploads/sample_excel/Product_Sample_Excel.xlsx'; ?>" target="_blank" class="btn btn-warning" download="Product_Sample_Excel.xlsx">Sample Excel File</a>
