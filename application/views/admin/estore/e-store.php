<div class="admin-content">
    <div class="container">
        <nav class="breadcrumb"> 
            <a class="breadcrumb-item" href="<?= site_url('admin/dashboard'); ?>">Admin</a> <span class="breadcrumb-item active">E-Store</span> 
                    ...
                    <tbody>
                        <?php if (count($storeData) > 0) : ?>
                            ...
                            foreach ($storeData as $store) {
                                ?>
                                <tr>                    
                                    <td class="min-width center id">#<?php echo $slno++;//echo $store->logoImage . ' ' . $slno++; ?></td>
                                    <td>                      
                                        <h2>
                                            <?php
                                            $CI =& get_instance();
