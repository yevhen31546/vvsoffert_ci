                        ...
                        <div class="pull-right">
                            <div class="cust-dropdown">
                                ...
                                <ul class="cust-dropdown-menu">
                                    <li><a href="<?php echo base_url() . 'uploads/sample_excel/sample_e_store_product_excel.xlsx'; ?>" target="_blank" class="" download="sample_e_store_product_excel.xlsx">Upload E-store product Excel</a></li>
                                    ...
                                    <li><a href="<?php echo base_url() . 'uploads/sample_excel/import_and_sync_e_store_link_for_rsk_no.xlsx'; ?>" target="_blank" class="" download="import_and_sync_e_store_link_for_rsk_no.xlsx">Sync E-Store Link Excel</a></li>
                                    <li><a href="<?php echo base_url() . 'uploads/sample_excel/import_and_sync_instock_for_rsk_no.xlsx'; ?>" target="_blank" class="" download="import_and_sync_instock_for_rsk_no.xlsx">Sync Instock Excel</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="pull-right">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="pro_import_type" name="pro_import_type">
                                    ...
                                    <option value="4">Update E-Store Link for RSK no</option>
                                    <option value="5">Update instock for RSK no</option>
                                </select>
