    ...
    <table class="table table-bordered">
        <thead>
            <tr>                   
                ...
                <th class="min-width center">Company Name</th>
                <th class="min-width center">Org No.</th>
                <th class="min-width center">phone</th>  
                <th class="min-width center">Join date</th>  
                ...
                <tr>                   
                    ...
                    <td class="min-width center">
                        <?php if ($user['status'] == 1) { ?>
                            <div class="bg-success text-white">Active</div>
                        <?php } else { ?>
                            <div class="bg-danger text-white">Inactive</div>
                        <?php } ?>
                    </td>
                    <td class="">      
