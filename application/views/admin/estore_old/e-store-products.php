<div class="admin-content">
    <div class="container">
        <nav class="breadcrumb"> 
            ...
            <?php if (isset($storeDetails) && count($storeDetails) > 0) : ?>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>                    
                            ...
                            <th style="width: 30%; text-transform: uppercase;">Product Name</th>                    
                            <th class="min-width center" style="width: 15%; text-transform: uppercase;">RSK No</th>                    
                            <th class="min-width center" style="width: 15%; text-transform: uppercase;">Discount Group</th>                    
                            <th class="min-width center" style="width: 5%; text-transform: uppercase;">Unit</th>                    
                            <th class="min-width center" style="width: 15%; text-transform: uppercase;">Price</th>                    
                            <th class="min-width center" style="width: 10%; text-transform: uppercase;">In Stock</th>                    
