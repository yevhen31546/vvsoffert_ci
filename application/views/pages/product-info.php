							...
							foreach($relateProductData as $product)
							{
								?>
                                	...
                                	<div class="listing-row-medium pad-5">
                                        <div class="listing-row-medium-inner"> <a href="<?php echo site_url('product?c='.urlencode($product->CNAME).'&p='.urlencode($product->Name).'&no='.$product->id); ?>" class="listing-row-medium-image"><img src="http://www.vvsoffert.se/scraper/<?php echo $product->ImageName; ?>"> </a>
