            ...
            <div class="col-md-3 col-sm-4">
                <div class="left_panel_wrapper">
                    <div class="sidebar hidden-lg hidden-md hidden-sm">
                        ...
                        <hr>
                        <!--<div class="overview category-column mb-3" id="pdt-compare-wrap">                         
                                ...
                                <div class="prdts_listing_content text-center">
                                    ...
                                    <div class="prdts_content_area">
                                        <div class="prdts_title">
                                            <h5><a class="vvsoffert-product-url" href="<?php echo site_url('product/' . url_title($product->Name) . '-pid-' . $product->id); ?>" id="<?php echo $product->id; ?>"><?php echo $product->Name; ?></a></h5>
                                        </div>
                                        <!--<div class="prdts_type"><a href="<?php echo site_url($product->CSLUG); ?>"><?php echo $product->CNAME; ?></a></div>-->
                                        <div class="prdts_type"><a href=""><?php echo $product->CNAME; ?></a></div>
                                        <div class="prdts_rsk_number paid_text1 border_bottom1"><b>RSK-No.</b><span class="sub_color"> <?php echo!empty($product->RSKnummer) ? $product->RSKnummer : '-'; ?></span></div>
                                    ...
                                    <?php if (isset($user_id) && $user_id != 0) { ?>
                                        <div class="add_compare_area add_compare_area-cst">
                                            ...
                                            <a style="/*margin-top: 10px; */background-color: #5a687f; color: #ffffff; font-size: 95%;" href="javascript:;" class="btn btn-xs" id="add_to_list_<?= $product->id ?>" data-productId="<?= $product->id ?>" data-rskNo="<?= $product->RSKnummer ?>" onclick="addToList(this)">
                                    ...
                                    <?php } else { ?>
                                        <div class="add_compare_area add_compare_area-cst">
                                            <a style="/*margin-top: 10px; */background-color: #5a687f; color: #ffffff; font-size: 95%;" class="btn btn-xs" href="<?= site_url('login') ?>">
                                                <i class="fa fa-sm fa-plus"></i>
                                                <b>Till lista</b>
                                            </a>
                                        </div>
