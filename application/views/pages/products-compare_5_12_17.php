                ...
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <div class="listing_details_screen_screen_title-2">
                            <h5>Compare Listings</h5>
                        </div>

                        <div class="listing_details_breadcrumb_pagination-2">
                            <ul class="breadcrumb">
                                <li><a href="http://localhost/vvsoffert/">Home</a> </li>
...
<!--            <div class="row">
        	...
        	<div class="col-sm-12 col-md-6 col-4 col-xs-12 no-padding">
            	<div class="features-table">
                	<ul>
                          
                    	<h1></h1>
                        <li>Banner in homepage forever </li>
                    	<li>Banner in homepage forever </li>
                    	<li>You can the winner of 50.000 $ contest </li>
                        <li>Post about your startup on our channels</li>
                        <li>Post about your startup during the contest</li>
                        <li>Your startup in our sponsored post</li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-12 col-md-2 col-2 col-xs-12 no-padding">
            <div class="features-table-free">
                	<ul>
                            <img src="http://localhost/vvsoffert/images/1/5555.jpg" class="img-responsive nw-img-height" alt="Vvs offert | Rörkalkyl | Vvs kalkyl | Anbud | Vvspriser |Vvsoffert | Vvs online | Rörgrossist">
                    	<h1>F?rminskning, Novo-Sit</h1>
                        <li><i class="fa fa-check"></i></li>
                        <li><i class="fa fa-check"></i></li>
                        <li><i class="fa fa-check"></i></li>
                        <li><i class="fa fa-check"></i></li>
                        <li><h3>F?rminskning</h3></li>
                         <li><i class="fa fa-check"></i></li>
