...
<section class="gallery_tabs">
    <div class="slider_products container">
        <div id="myCarouse2" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                        <div class="item active">
                                                            <div class="col-xs-12 col-sm-3 gallery_img hidden-xs">
                                <div class="radius_img hidden-xs"> 
                                                                                <img src="https://vvsoffert.se/uploads/group-images/1513152780_image circle nr 1.jpg" class="img-responsive" alt="Rör &amp; teknisk armatur" height="111"> 
                                                                        </div>
                                <div class="gallery_title text-center"> <a data-toggle="tab" href="#link1_0">Rör &amp; teknisk armatur</a> </div>
                            </div>
                            <!--end-product-->
                                                                                                                    <div class="col-xs-12 col-sm-3 gallery_img hidden-xs">
                                <div class="radius_img hidden-xs"> 
                                                                                <img src="https://vvsoffert.se/uploads/group-images/1513152803_image circle nr 2.jpg" class="img-responsive" alt="Sanitet &amp; rostfritt" height="111"> 
                                                                        </div>
                                <div class="gallery_title text-center"> <a data-toggle="tab" href="#link1_1">Sanitet &amp; rostfritt</a> </div>
                            </div>
                            <!--end-product-->
                                                                                                                    <div class="col-xs-12 col-sm-3 gallery_img hidden-xs">
                                <div class="radius_img hidden-xs"> 
                                                                                <img src="https://vvsoffert.se/uploads/group-images/1513152822_image circle nr 3.png" class="img-responsive" alt="Ventilation" height="111"> 
                                                                        </div>
                                <div class="gallery_title text-center"> <a data-toggle="tab" href="#link1_2">Ventilation</a> </div>
                            </div>
                            <!--end-product-->
                                                                                                                    <div class="col-xs-12 col-sm-3 gallery_img hidden-xs">
                                <div class="radius_img hidden-xs"> 
                                                                                <img src="https://vvsoffert.se/uploads/group-images/1513152838_image circle nr 4.jpg" class="img-responsive" alt="Värme &amp; pumpar" height="111"> 
                                                                        </div>
                                <div class="gallery_title text-center"> <a data-toggle="tab" href="#link1_3">Värme &amp; pumpar</a> </div>
                            </div>
                            <!--end-product-->
        ...
        <div class="clearfix"></div>
        <div class="tab-content change_tab_text hidden-xs">
                                <div id="link1_0" class="tab-pane fade in active">
                    <p><a href="https://vvsoffert.se/gjutjarnsror">Gjutjärnsrör</a>, <a href="https://vvsoffert.se/stal-aluminium-rostfria-ror">Stål-/Aluminium-/Rostfria rör</a>, <a href="https://vvsoffert.se/kopparror">Kopparrör</a>, <a href="https://vvsoffert.se/plastror-tryck">Plaströr - Tryck</a>, <a href="https://vvsoffert.se/plastror-avlopp">Plaströr - Avlopp</a>, <a href="https://vvsoffert.se/plastror-ovriga">Plaströr - Övriga</a>, <a href="https://vvsoffert.se/fastdetaljertatningisolering">Fästdetaljer/Tätning/Isolering</a>, <a href="https://vvsoffert.se/va-armaturstangventiler">VA-armatur/Stängventiler</a>, <a href="https://vvsoffert.se/reglerventilerovrig-armatur">Reglerventiler/Övrig armatur</a>, <a href="https://vvsoffert.se/matinstrument">Mätinstrument</a>                        </p>
                </div>
                                <div id="link1_1" class="tab-pane fade ">
                    <p><a href="https://vvsoffert.se/badkarduschkabiner-vaggar">Badkar/Duschkabiner/-väggar</a>, <a href="https://vvsoffert.se/tvattstalldricksfontaner">Tvättställ/Dricksfontäner</a>, <a href="https://vvsoffert.se/wc-stolarbideerurinaler">WC-stolar/Bidéer/Urinaler</a>, <a href="https://vvsoffert.se/disk-tvatt-stadutrustning">Disk-/Tvätt-/Städutrustning</a>, <a href="https://vvsoffert.se/vattenlaskonsolerfixturer">Vattenlås/Konsoler/Fixturer</a>, <a href="https://vvsoffert.se/blandare">Blandare</a>, <a href="https://vvsoffert.se/sanitetsarmatur-utrustning">Sanitetsarmatur/-utrustning</a>, <a href="https://vvsoffert.se/badrumsutrustning">Badrumsutrustning</a>                        </p>
                </div>
                                <div id="link1_2" class="tab-pane fade ">
                    <p><a href="https://vvsoffert.se/ventilationsprodukter">Ventilationsprodukter</a>                        </p>
                </div>
                                <div id="link1_3" class="tab-pane fade ">
                    <p><a href="https://vvsoffert.se/automatikstyrventiler">Automatik/Styrventiler</a>, <a href="https://vvsoffert.se/karlcisternerreningsutrustning">Kärl/Cisterner/Reningsutrustning</a>, <a href="https://vvsoffert.se/pumpar">Pumpar</a>, <a href="https://vvsoffert.se/pannorvarmepumpar">Pannor/Värmepumpar</a>, <a href="https://vvsoffert.se/radiatorerkonvektorer">Radiatorer/Konvektorer</a>, <a href="https://vvsoffert.se/vatten-medievarmaretankar">Vatten-/Medievärmare/Tankar</a>                        </p>
                </div>
            </div>
    </div>
    <div class="top_xs_tabs hidden-lg hidden-md hidden-sm">
        <div class="panel-group" id="accordion">
                                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse0">Rör &amp; teknisk armatur</a>
                        </h4>
                    </div>
                    <div id="collapse0" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <a href="https://vvsoffert.se/gjutjarnsror">Gjutjärnsrör</a>, <a href="https://vvsoffert.se/stal-aluminium-rostfria-ror">Stål-/Aluminium-/Rostfria rör</a>, <a href="https://vvsoffert.se/kopparror">Kopparrör</a>, <a href="https://vvsoffert.se/plastror-tryck">Plaströr - Tryck</a>, <a href="https://vvsoffert.se/plastror-avlopp">Plaströr - Avlopp</a>, <a href="https://vvsoffert.se/plastror-ovriga">Plaströr - Övriga</a>, <a href="https://vvsoffert.se/fastdetaljertatningisolering">Fästdetaljer/Tätning/Isolering</a>, <a href="https://vvsoffert.se/va-armaturstangventiler">VA-armatur/Stängventiler</a>, <a href="https://vvsoffert.se/reglerventilerovrig-armatur">Reglerventiler/Övrig armatur</a>, <a href="https://vvsoffert.se/matinstrument">Mätinstrument</a>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Sanitet &amp; rostfritt</a>
                        </h4>
                    </div>
                    <div id="collapse1" class="panel-collapse collapse ">
                        <div class="panel-body">
                            <a href="https://vvsoffert.se/badkarduschkabiner-vaggar">Badkar/Duschkabiner/-väggar</a>, <a href="https://vvsoffert.se/tvattstalldricksfontaner">Tvättställ/Dricksfontäner</a>, <a href="https://vvsoffert.se/wc-stolarbideerurinaler">WC-stolar/Bidéer/Urinaler</a>, <a href="https://vvsoffert.se/disk-tvatt-stadutrustning">Disk-/Tvätt-/Städutrustning</a>, <a href="https://vvsoffert.se/vattenlaskonsolerfixturer">Vattenlås/Konsoler/Fixturer</a>, <a href="https://vvsoffert.se/blandare">Blandare</a>, <a href="https://vvsoffert.se/sanitetsarmatur-utrustning">Sanitetsarmatur/-utrustning</a>, <a href="https://vvsoffert.se/badrumsutrustning">Badrumsutrustning</a>                            </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Ventilation</a>
                        </h4>
                    </div>
                    <div id="collapse2" class="panel-collapse collapse ">
                        <div class="panel-body">
                            <a href="https://vvsoffert.se/ventilationsprodukter">Ventilationsprodukter</a>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Värme &amp; pumpar</a>
                        </h4>
                    </div>
                    <div id="collapse3" class="panel-collapse collapse ">
                        <div class="panel-body">
                            <a href="https://vvsoffert.se/automatikstyrventiler">Automatik/Styrventiler</a>, <a href="https://vvsoffert.se/karlcisternerreningsutrustning">Kärl/Cisterner/Reningsutrustning</a>, <a href="https://vvsoffert.se/pumpar">Pumpar</a>, <a href="https://vvsoffert.se/pannorvarmepumpar">Pannor/Värmepumpar</a>, <a href="https://vvsoffert.se/radiatorerkonvektorer">Radiatorer/Konvektorer</a>, <a href="https://vvsoffert.se/vatten-medievarmaretankar">Vatten-/Medievärmare/Tankar</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="carousel-inner">
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=FM-Mattsson-9000E-II-Duschset&no=220771">FM Mattsson 9000E ...</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=FM-Mattsson-9000E-II-Köksblandare&no=217414">FM Mattsson 9000E ...</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Tvättställsblandare-9000E-II-med-silpluggventil&no=215190">Tvättställsbland...</a></h3>
                                    </div>
                                    <div class="product_type"><a href="https://vvsoffert.se/blandare">Blandare</a></div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Vattenlåssats-Falu-44100&no=212081">Vattenlåssats, Fa...</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Ifö-Sign-6893&no=208193">Ifö Sign 6893</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=IFÖ-SIGN-6861&no=208107">IFÖ SIGN 6861</a></h3>
                                    </div>
                                    <div class="product_type"><a href="https://vvsoffert.se/wc-stolarbideerurinaler">WC-stolar/Bidéer/...</a></div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Ifö-Sign-6860&no=208045">Ifö Sign 6860</a></h3>
                                    </div>
                                    <div class="product_type"><a href="https://vvsoffert.se/wc-stolarbideerurinaler">WC-stolar/Bidéer/...</a></div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Ifö-Spira-15022&no=206823">Ifö Spira 15022</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Nibe-Eminent-CU-55&no=193806">Nibe Eminent-CU 55</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Nibe-F730&no=181086">Nibe F730</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Pumppaket-SQE-2-70&no=173509">Pumppaket, SQE 2-7...</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Golvbrunn-Oden&no=164292">Golvbrunn, Oden</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Installationssats-A500-11&no=159024">Installationssats,...</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Injusteringsventil-STAD-G15&no=153047">Injusteringsventil...</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Ventildel-RA-N-10&no=151824">Ventildel, RA-N, 1...</a></h3>
                                    </div>
                                    <div class="product_type"><a href="https://vvsoffert.se/reglerventilerovrig-armatur">Reglerventiler/Öv...</a></div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Radiatorkoppel-VRVMFA-2-rörs&no=151615">Radiatorkoppel, VR...</a></h3>
                                    </div>
                                    <div class="product_type"><a href="https://vvsoffert.se/reglerventilerovrig-armatur">Reglerventiler/Öv...</a></div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Propp-10&no=151284">Propp 10</a></h3>
                                    </div>
                                    <div class="product_type"><a href="https://vvsoffert.se/reglerventilerovrig-armatur">Reglerventiler/Öv...</a></div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Termostatdel-Evosense-0-28&no=151031">Termostatdel, Evos...</a></h3>
                                    </div>
                                    <div class="product_type"><a href="https://vvsoffert.se/reglerventilerovrig-armatur">Reglerventiler/Öv...</a></div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Regulatordel-RA-2990-7-28&no=151006">Regulatordel, RA 2...</a></h3>
                                    </div>
                                    <div class="product_type"><a href="https://vvsoffert.se/reglerventilerovrig-armatur">Reglerventiler/Öv...</a></div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Kulventil-Vatette-12-med-vred&no=147905">Kulventil, Vatette...</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Kulventil-Vatette-12X10-med-vred&no=145096">Kulventil, Vatette...</a></h3>
                                    </div>
                                    <div class="product_type"><a href="https://vvsoffert.se/va-armaturstangventiler">VA-armatur/Stängv...</a></div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Rörklamma-Falu-Snap-dubbel-12-15-FK&no=134465">Rörklamma, Falu S...</a></h3>
                                    </div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Takjärn-Universal-L2m&no=129577">Takjärn, Universa...</a></h3>
                                    </div>
                                    <div class="product_type"><a href="https://vvsoffert.se/fastdetaljertatningisolering">Fästdetaljer/Tät...</a></div>
                            ...
                            <!--end-product-->
                                ...
                                <div class="product_content text-center">
                                    ...
                                    <div class="product_title">
                                        <h3><a href="https://vvsoffert.se/product?pname=Böj-Nordic-110-mm-x-45&no=123643">Böj, Nordic 110 m...</a></h3>
                                    </div>
...
<section class="Register_section">
    <div class="container">
        <div class="col-xs-12 col-sm-7 left_text">
            <h3><span class="color_text">VVS Kalkyl online</span> </h3>
            <p><h2>När du har registrerat dig på vvsoffert.se - Så kan du göra vvs kalkyler, jämföra priserna på VVS-produkter från alla kända VVS-grossister, jämföra 3 olika VVS-produkter med varandra. spara till dina egna listor, importera egna listor med rörprodukter i excel. Importera dina egna priser och du kan även göra offerter och fakturor.</h2></p>
            <div class="reg_btn_bottom"> <a href="<?= site_url('home/signup') ?>" class="reg-btn"><i class="fa fa-sign-in-alt"></i> Registrera nu</a> </div>
        </div>
        <div class="col-xs-12 col-sm-5 reg_img_right"> <img src="<?=base_url().'assets/img/vvskalkyl.jpg'?>" class="img-responsive center-block" alt="Vvs offert | Rörkalkyl | Vvs kalkyl | Anbud | Vvspriser |Vvsoffert | Vvs online | Kalkylprogram vvs" width="300" height="168"> </div>
        <div class="clearfix"></div>
    </div>
</section>       