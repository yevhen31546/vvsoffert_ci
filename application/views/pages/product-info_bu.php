                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden-xs" style="width: 25%;">
                                                    <?php if (strtolower($v->in_stock) == 'j' || $v->in_stock == 1) : ?>
                                                        <span style="background-color: #14AD6F; padding: 2px 5px; color: white;"><i class="fa fa-check"></i> I Lager</span>
                                                    <?php elseif (strtolower($v->in_stock) == 'n' || $v->in_stock == 0) : ?>
                                                        <span style="background-color: #f37452; padding: 2px 5px; color: white;"><i class="fa fa-times"></i> Ej I Lager</span>
                                                    <?php else : ?>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="hidden-xs" style="width: 25%;"><a class="btn btn-sm btn-primary" href="<?= $v->e_store_link; ?>"<?= ($v->e_store_link) ? '' : ' disabled="disabled"'; ?>> <i class="fa fa-shopping-cart"></i> Se Butik</a></td>
                                                <td class="hidden-lg hidden-md hidden-sm" style="width: 75%;">
                                                    ...
                                                    <br>
                                                    <?php if (strtolower($v->in_stock) == 'j' || $v->in_stock == 1) : ?>
                                                        <span style="background-color: #14AD6F; padding: 2px 5px; color: white; font-size: 80%; margin-bottom: 10px; display: inline-block;"><i class="fa fa-check"></i> I Lager</span>
                                                    <?php elseif (strtolower($v->in_stock) == 'n' || $v->in_stock == 0) : ?>
                                                        <span style="background-color: #f37452; padding: 2px 5px; color: white; font-size: 80%; margin-bottom: 10px; display: inline-block;"><i class="fa fa-times"></i> Ej I Lager</span>
                                                    <?php else : ?>
                                                    <?php endif; ?>
                                                    <br>
                                                    <a class="btn btn-xs btn-primary" href="<?= $v->e_store_link; ?>"<?= ($v->e_store_link) ? '' : ' disabled="disabled"'; ?>> <i class="fa fa-shopping-cart"></i> Se Butik</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else : ?>
