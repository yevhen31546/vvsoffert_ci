                    ...
                    <div class="signup_form">
                        ...
                        <div class="form-group col-xs-12 col-sm-12">
                            <div class="icon-addon">
                                <input type="text" placeholder="Kundnamn" class="form-control" id="name" name="name" value="">
                        ...
                        <div class="form-group col-xs-12 col-sm-12 ">
                            <div class="icon-addon">
                                <input type="text" placeholder="Adress" class="form-control" id="address" name="address" autocomplete="off" value="">
                                <label for="Address" class="fa fa-address-card-o" rel="tooltip" title="Cutomer's Address"></label>
                            </div>
                        </div>
                        <div class="form-group col-xs-12 col-sm-12">
                            <div class="icon-addon">
                                <input type="text" placeholder="Postnummer och ort" class="form-control" id="city" name="city" autocomplete="off" value="">
                        ...
                        <div class="form-group col-xs-12 col-sm-12">
                            <div class="icon-addon">
                                <textarea type="text" placeholder="Projket" class="form-control" id="special_comments" name="special_comments" autocomplete="off" value="" ></textarea>
                                <label for="special_comments" class="fa fa-sticky-note" rel="tooltip" title="Special Country"></label>
                            </div>
                        </div>                       
                        <div class="form-group col-xs-12 col-sm-12">
                            <div class="icon-addon">
                                <input type="text" placeholder="Projektnummer" class="form-control" id="city" name="invoice_number" value="<?php echo (rand(1, 1000)); ?>" autocomplete="off" value="">
                                <label for="city" class="fa fa-building" rel="tooltip"></label>
                            </div>
                        </div>
                        <div class="form-group col-xs-12 col-sm-12">
                            <div class="icon-addon">
                                <select class="form-control store_id" id="store_name" name="store_name">

                                    <?php foreach ($estoreAllList as $estore) { ?>
                                        <option value="<?php echo $estore->name . '-' . $estore->id; ?>"><?php echo $estore->name; ?></option>                                
                                    <?php } ?>
                        ...
                        <div class="form-group col-xs-12 col-sm-12">
                            <div class="icon-addon">
                                <input type="text" placeholder="sök RSK- nummer eller produktnamn" class="form-control width85" id="search_products" name="search_products" value="" />
                                <span class="input-group-btn">
                                    <button class="btn btn-secondary search-button" type="button">Search</button>
                                </span>
                        ...
                        <div class="form-group col-xs-12 col-sm-12">
                            <label class="lblProducts">Vaij produckter</label>
                            <div class="icon-addon">
                                <ul id="selected_pros">
                                    <?php
                                    if (!empty($productlist)) {
                                        foreach ($productlist as $key => $pro) {
                                            if(isset($pro->pro_name)){
                                            ?>
