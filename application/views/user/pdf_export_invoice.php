...
<!--                    <span style="color: #9E9E9E; font-size: 18px; font-style: italic;">><?php echo isset($post['invoice_type']) ? $post['invoice_type'] : ''; ?></span>-->
                    <span style="color: #9E9E9E; font-size: 40px; font-style: italic; text-align: center;"><?php echo isset($post['invoice_type']) ? $post['invoice_type'] : ''; ?></span>
                     <p style="margin-bottom: 0px !important; font-weight: 300 !important; text-transform: uppercase !important; font-size: 15px;color: #9E9E9E; "><span style="color: #9E9E9E;font-size: 16px;"><?php echo isset($post['invoice_typeh']) ? $post['invoice_typeh'] : ''; ?> Nummer:</span>&nbsp;&nbsp;<?= $post['invoice_number']; ?></p>
            ...
            <tr>
                <th width="50%" style="text-align:left; vertical-align: middle; padding: 0px 0px 0px 15px;">
                    <p style="margin-bottom: 0px !important; font-weight: 300 !important; text-transform: uppercase !important; font-size: 15px;color: #9E9E9E; "><span style="color: #9E9E9E;font-size: 16xp;">Kund:</span>&nbsp;&nbsp;<?= $post['name'] ?></p>
                    <p style="margin-bottom: 0px !important; font-weight: 300 !important; text-transform: uppercase !important; font-size: 15px;color: #9E9E9E; "><span style="color: #9E9E9E;font-size: 16px;">Mail:</span>&nbsp;&nbsp;<?= $post['email']; ?></p>
                </th>
            </tr>
            <tr>
