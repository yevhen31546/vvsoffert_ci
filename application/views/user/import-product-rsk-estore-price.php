    ...
    <div class="overall_content">
        <div class="section_content">
            <div class="table_header">
                <div class="table_title fl"><i class="fa fa-upload"></i> Importera Produkter RSK Nummer & Pris</div>
                            ...
                            <div class="clearfix">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <div class="import-action">
                                        <a href="<?php echo base_url() . 'uploads/sample_excel/Produkt_RSK_User_Import_Pris.xlsx'; ?>" target="_blank" class="btn btn-warning pull-left" download="Produkt_RSK_User_Import_Pris.xlsx">Öppna import mall</a>
