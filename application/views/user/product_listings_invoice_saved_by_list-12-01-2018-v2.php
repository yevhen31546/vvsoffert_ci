    ...
    <div class="overall_content">
        <form action="<?php echo site_url('list-invoice-save'); ?>" method='post'>
            <div class="section_content">
                <div class="table_header">
                    <div class='row'>
                        ...
                        <div class="col-md-6" style="text-align:right;">
                            <h2><?php echo $post["invoice_type"]; ?></h2>
                        </div>
                    </div>
                    <div class='row'>
                        <div class="col-md-6">
                    ...
                    <div class='row'>
                        <div class="col-md-6">
                                <p><b><?php echo $post["customer_name_text"]; ?></b>: <?php echo $post["Kundnamn"]; ?></p>
                                <p><b><?php echo $post["email_text"]; ?></b>: <?php echo $post["E-post"]; ?></p>
                        </div>
                        <div class="col-md-6" style="text-align:right;">
                ...
                <center><b><?php echo $post["thanks_for_your_busssiness"]; ?></b></center>
                <div style="text-align:right; padding: 15px 0;">
                    <a href="<?php echo site_url('list-invoice-reedit') . '?' . http_build_query($_POST); ?>" class="reg-btn" style="padding: 10px 15px; font-size:16px;">Redigera</a>
                    <a target="_blank" href="<?php echo site_url('pdf-export-invoice-edited') . '?' . http_build_query($_POST); ?>" class="reg-btn" style="padding: 10px 15px; font-size:16px;">E-post</a>
                    <a target="_blank" href="<?php echo site_url('pdf-export-invoice-edited') . '?action=pdf_export&' . http_build_query($_POST); ?>" class="reg-btn" style="padding: 10px 15px; font-size:16px;">PDF</a>
                </div>
