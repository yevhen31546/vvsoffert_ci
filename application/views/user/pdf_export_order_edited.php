    ...
    <div style="">
        ...
        <table style="padding: 10px 5px; border-radius: 3px !important; margin-top:0%;font-family: helvetica;" width="100%">
            <tr>
                ...
                <th width="50%" style="text-align:left; vertical-align: middle; padding: 0px 0px 0px 15px;">
                    <p style="    margin-top: 0px;margin-bottom: 3%; !important; text-transform: uppercase !important; font-size: 24px; color: #000000 !important; font-weight: 700;">Faktura preliminär</p>
                    <p style="    margin-top: 0px;margin-bottom: 3%; !important; text-transform: uppercase !important; font-size: 20px; color: #000000 !important; font-weight: 700;">Fakturanummer &nbsp;&nbsp;&nbsp;&nbsp;<?= !empty($order_id) ? $order_id + 1200 : ''; ?></p>
                </th>
            </tr>
            <tr style="">
                <th width="50%" style="text-align:left; vertical-align: middle; padding: 0px 0px 0px 15px;">
            ...
            <tr>
                <th width="50%" style="text-align:left; vertical-align: middle; padding: 0px 0px 0px 15px;">
                    <table>
                        ...
                        <tr>
                            <th width="30%" style="text-align:left; vertical-align: middle; padding: 0px 0px 0px 15px;">
                                <p style="    margin-top: 5px;margin-bottom: 1%; !important; font-weight: 300 !important; text-transform: uppercase !important; font-size: 16px;color: #000000 !important; ">Kundens </p>
                            </th>
                            <th width="70%" style="text-align:left; vertical-align: middle; padding: 0px 0px 0px 15px;">
