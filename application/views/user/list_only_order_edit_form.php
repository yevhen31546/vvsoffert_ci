...
<div class="col-xs-12 col-sm-9 col-xl-10 table_content">
    <div class="overall_content">
                ...
                <form id="make_order_form" name="make_order_form" method="post" action="<?php echo site_url('user/pdf_export_only_order_edited'); ?>" style="margin-top:35px;" enctype="multipart/form-data">
                                ...
                                <div class="col-md-8 col-sm-12 input-group">
                                    <select style="line-height:28px; padding-left:5px; height: 40px;" class="form-control store_id" id="customer_sel" name="customer_sel" >
                                        ...
                                        <?php foreach ($customers as $customer) { 
                                            if ($customer->id == $order_info[0]->customer_sel){?>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="col-xs-12 col-sm-12" style="height:auto;">
                                ...
                                <div class="col-md-8 col-sm-12 input-group date datetimepicker" id='invoice_date_value'>
                                    <input type='text' id="order_date" name="order_date" class="form-control"  style = "height: 40px;"  value="<?php echo set_value('order_date', $order_info[0]? $order_info[0]->order_date :''); ?>"/>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="col-xs-12 col-sm-12" style="height:auto;">
                                ...
                                <div class="col-md-8 col-sm-12 input-group date datetimepicker" id='due_date_value'>
                                    <input type='text' id="plan_delivery_date" name="plan_delivery_date" class="form-control"  style = "height: 40px;"/  value="<?php echo set_value('plan_delivery_date', $order_info[0]? $order_info[0]->plan_delivery_date :''); ?>">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar" style = "padding-top: 5px;"></span>
                                    </span>
                                </div>
                ...
                <div class="form-group col-sm-12" style = "margin-bottom: 0px; padding:0;">
                    <div class="col-md-4 col-sm-12">
                        <div class="col-xs-12 col-sm-12" style="height:auto;">
                                ...
                                <div class="col-md-8 col-sm-12 input-group">
                                    <input type="text" placeholder="" style="height:40px" class="form-control" id="your_ref" name="your_ref"  value="<?php echo set_value('your_ref', $order_info[0]? $order_info[0]->your_ref :''); ?>">
                                </div>
                                <span style="color:red;"><?php ?></span>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="col-xs-12 col-sm-12" style="height:auto;">
                                ...
                                <div class="col-md-8 col-sm-12 input-group">
                                    <input type="text" placeholder="" style="height:40px" class="form-control" id="our_ref" name="our_ref"  value="<?php echo set_value('our_ref', $order_info[0]? $order_info[0]->our_ref :''); ?>">
                                </div>
                                <span style="color:red;"><?php ?></span>
                        </div>
                    </div>
                    <div class="icon-addon col-sm-4">
                        <div class="col-xs-12 col-sm-12" style="height:auto;">
                            ...
                            <div class="col-md-8 col-sm-12 input-group">
                                <select style="line-height:28px; padding-left:5px; height: 40px;font-size:20px;" class="form-control store_id" id="store_name_inv" name="store_name_inv">
                                    <?php  
                                        $sel_store = explode ("-", $order_info[0]->store_name_inv);
                        ...
                        <div class="col-md-4 col-sm-12" style="display:none;">
                            <div class="col-xs-12 col-sm-12" style="height:auto;">
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label control-label">Order ID</label>
                                    </div>
                                    <div class="col-md-8 col-sm-12">
                                        <input type="text" placeholder="" style="height:40px;" class="form-control" id="id" name="id" value="<?php echo set_value('id', $order_info[0]? $order_info[0]->id :''); ?>">
                                    </div>
                                    <span style="color:red;"><?php ?></span>
                            </div>
                        </div>
                        ...
                        <div class = "col-sm-12" id="add-article-area" style = "min-height: 50px; margin-top:20px">
                            ...
                            <div class="col-sm-12 row head_caption" id="head_caption_order_edit">
                           ...
                           <? 
                            ...
                            $art_idarys = json_decode($order_info[0]->art_id,true);
                            $art_namearys = json_decode($order_info[0]->art_name,true);
                            $art_quantityarys = json_decode($order_info[0]->art_quantity,true);
                            $unitarys = json_decode($order_info[0]->unit,true);
                            $price_exclarys = json_decode($order_info[0]->sale_price_excl,true);
                            $discountarys = json_decode($order_info[0]->discount,true);
                            $sum_excl = json_decode($order_info[0]->sum_excl,true);
                            $price_list = json_decode($order_info[0]->price_list,true);
                        ...
                        <div class="col-sm-12" style="margin-top:30px">
                            ...
                            <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="col-md-5 col-sm-12">
                                        <input type="text" style="font-size:20px;" placeholder="" style="height:40px;" class="form-control" id="total_sum" name="total_sum" value="<?php echo set_value('total_sum', $order_info[0]? $order_info[0]->total_sum :''); ?>">
                                    </div>
                        ...
                        <div class="col-md-12" style = "margin-top:30px;">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12 col-lg-3 preview_pdf" style="padding-top:10px !important;">
                                <? $send_id = $order_info[0]? $order_info[0]->id :''; ?>
                                <a target="_blank" href="<?echo site_url('pdf-export-order-preview-new') . '?inv_id=' .$send_id ;  ?>" class="" style="color:white !important; padding-left:47px;">Förhands</a>
                            </div>
                            <div class="col-md-3 col-sm-12 col-xs-12 col-lg-3 down_pdf" style="padding-top:10px !important;margin-left:30px;">
                                <? $send_id = $order_info[0]? $order_info[0]->id :''; ?>
                                <a target="_blank" href="<?echo site_url('pdf-export-order-edited-new') . '?inv_id=' .$send_id ;  ?>" class="" style="color:white !important; padding-left:22px;">Ladda ner PDF</a>
                            </div>
                        </div>
