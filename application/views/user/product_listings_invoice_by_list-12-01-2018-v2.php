    ...
    <div class="overall_content">
        <div class="section_content">
                ...
                <div class='row'>
                    <div class="col-md-6">
                        <?php if (isset($_REQUEST['name'])) { ?>
                            <p><b>Customer Name</b>: <?php echo isset($_REQUEST['name']) ? $_REQUEST['name'] : ''; ?></p>
                        <?php } ?>
            ...
            <div style="text-align:right; padding: 15px 0;">
                <a target="_blank" href="<?php echo site_url('list-invoice-edit') . '?action=pdf_export&company_name=' . $model->company_name . '&company_contact=' . $model->contact . '&' . http_build_query($_POST); ?>" class="reg-btn" style="padding: 10px 15px; font-size:16px;">Edit <i class="fa fa-pencil"></i></a>
                <a target="_blank" href="<?php echo site_url('pdf-export-invoice') . '?action=send_email&company_name=' . $model->company_name . '&company_contact=' . $model->contact . '&' . http_build_query($_POST); ?>" class="reg-btn" style="padding: 10px 15px; font-size:16px;">Send Email</a>
                <a target="_blank" href="<?php echo site_url('pdf-export-invoice') . '?action=pdf_export&company_name=' . $model->company_name . '&company_contact=' . $model->contact . '&' . http_build_query($_POST); ?>" class="reg-btn" style="padding: 10px 15px; font-size:16px;">Download as PDF</a>
            </div>
