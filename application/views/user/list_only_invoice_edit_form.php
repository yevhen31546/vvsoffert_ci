                ...
                <div class="row signup_screen" style = "width: 100%!important; margin-top: -20px; border-top: 5px none; padding-left: 10px; max-width:initial;">
                    ...
                    <form id="make_invoice_form" name="make_invoice_form" method="post" action="<?php echo site_url('user/pdf_export_only_invoice_edited'); ?>" enctype="multipart/form-data">
                        <div class="form-group col-sm-12" style = "margin-bottom: 0px; padding:0;">
                                        ...
                                        <div class="col-md-8 col-sm-12 input-group">
                                            ...
                                            <select style="line-height:28px; padding-left:5px; height: 40px;" class="form-control store_id" id="customer_sel" name="customer_sel" >
                                                ...
                                                <?php foreach ($customers as $customer) { 
                                                    if ($customer->id == $invoice_info[0]->customer_sel){?>
                            ...
                            <div class="col-md-3 col-sm-12">
                                <!--<div class="form-group checkbox-form">-->
                                    <div class="checkbox">
                                        <label>
                                            <input id="active" name="credit_note" type="checkbox" <?php echo $invoice_info[0]->credit_note? "checked" :''; ?>>
                                            <span style="font-weight: 700;">Kreditfaktura</span>
                                        </label>
                                    </div>
                                <!--</div>-->
                            </div>
                            <div class="col-md-3 col-sm-12">
                                <!--<div class="form-group checkbox-form">-->
                                    <div class="checkbox">
                                        <label>
                                            <input id="active" name="reccuring_invoice" type="checkbox" <?php echo $invoice_info[0]->reccuring_invoice? "checked" :''; ?>>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="col-md-12 col-sm-12" style="height:auto;">
                                        ...
                                        <div class="col-md-8 col-sm-12 input-group date datetimepicker" id='invoice_date_value'>
                                            <input type='text' id="invoice_date_value" name="invoice_date_value" class="form-control"  style = "height: 40px;" value="<?php echo set_value('invoice_date_value', $invoice_info[0]? $invoice_info[0]->invoice_date_value :''); ?>"/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="col-md-12 col-sm-12" style="height:auto;">
                                        ...
                                        <div class="col-md-8 col-sm-12 input-group date datetimepicker" id='due_date_value'>
                                            <input type='text' id="due_date_value" name="due_date_value" class="form-control"  style = "height: 40px;" value="<?php echo set_value('due_date_value', $invoice_info[0]? $invoice_info[0]->due_date_value :''); ?>"/>
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar" style = "padding-top: 5px;"></span>
                                            </span>
                                        </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="col-xs-12 col-sm-12" style="height:auto;">
                                        ...
                                        <div class="col-md-8 col-sm-12 input-group date datetimepicker" id='delivery_date_value'>
                                            <input type='text' id="delivery_date_value" name="delivery_date_value" class="form-control"  style = "height: 40px;" value="<?php echo set_value('delivery_date_value', $invoice_info[0]? $invoice_info[0]->delivery_date_value :''); ?>"/>
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar" style = "padding-top: 5px;"></span>
                                            </span>
                                        </div>
                        ...
                        <div class="form-group col-sm-12" style = "margin-bottom: 15px; padding:0;">
                            <div class="col-md-4 col-sm-12">
                                <div class="col-xs-12 col-sm-12" style="height:auto;">
                                        ...
                                        <div class="col-md-8 col-sm-12 input-group">
                                            <input type="text" placeholder="" style="height:40px;" class="form-control" id="your_ref" name="your_ref" value="<?php echo set_value('your_ref', $invoice_info[0]? $invoice_info[0]->your_ref :''); ?>">
                                        </div>
                                        <span style="color:red;"><?php ?></span>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="col-xs-12 col-sm-12" style="height:auto;">
                                        ...
                                        <div class="col-md-8 col-sm-12 input-group">
                                            <input type="text" placeholder="" style="height:40px;" class="form-control" id="our_ref" name="our_ref" value="<?php echo set_value('our_ref', $invoice_info[0]? $invoice_info[0]->our_ref :''); ?>">
                                        </div>
                                        <span style="color:red;"><?php ?></span>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="col-xs-12 col-sm-12" style="height:auto;">
                                        ...
                                        <div class="col-md-8 col-sm-12 input-group">
                                            <input type="text" placeholder="" style="height:40px;" class="form-control" id="custom_ref" name="custom_ref" value="<?php echo set_value('custom_ref', $invoice_info[0]? $invoice_info[0]->custom_ref :''); ?>">
                                        </div>
                                        <span style="color:red;"><?php ?></span>
                                </div>
                            </div>
                        ...
                        <!-- <div class="icon-addon col-sm-4">
                            <div class="col-md-4 col-sm-12">
                                <label for="store" rel="tooltip" title="Slect Article">Select Article:</label>
                            </div>
                            <div class="col-md-8 col-sm-12">
                                <select style="line-height:28px; padding-left:5px; height: 40px;font-size:20px;" class="form-control article_num" id="article_num" name="article_num">

                                    <?php foreach ($articles as $article) { ?>
                                        <option value='<?php echo $article->art_num ?>' attr-quantity='<?php echo $article->stock_bal; ?>' attr-price_list='<?php echo $article->price_list; ?>' attr-unit='<?php echo $article->unit; ?>' attr-art_name='<?php echo $article->art_name; ?>' attr-sale_price_excl='<?php echo $article->sale_price_excl; ?>'><?php echo $article->art_num ?></option>                                
                                    <?php } ?>
                                </select>
                            </div>
                        </div> -->
                            ...
                            <div class="col-xs-12 col-sm-12" style="height:auto;">
                                ...
                                <div class="col-md-8 col-sm-12 input-group">
                                    <select style="line-height:28px; padding-left:5px; height: 40px;font-size:20px;" class="form-control store_id" id="store_name_inv" name="store_name_inv">
                                        <?php  
                                            $sel_store = explode ("-", $invoice_info[0]->store_name_inv);
                        ...
                        <div class="col-md-4 col-sm-12" style="display:none;">
                            <div class="col-xs-12 col-sm-12" style="height:auto;">
                                    ...
                                    <div class="col-md-8 col-sm-12 input-group">
                                        <input type="text" placeholder="" style="height:40px;" class="form-control" id="id" name="id" value="<?php echo set_value('id', $invoice_info[0]? $invoice_info[0]->id :''); ?>">
                                    </div>
                                    <span style="color:red;"><?php ?></span>
                            </div>
                        </div>
                        ...
                        <div class = "col-sm-12" id="add-article-area" style = "min-height: 50px; margin-top:20px">
                            ...
                            <div class="col-sm-12 row head_caption" id="head_caption_invoice_edit">
                           ...
                           <? 
                            ...
                            $art_idarys = json_decode($invoice_info[0]->art_id,true);
                            $art_namearys = json_decode($invoice_info[0]->art_name,true);
                            $art_quantityarys = json_decode($invoice_info[0]->art_quantity,true);
                            $unitarys = json_decode($invoice_info[0]->unit,true);
                            $price_exclarys = json_decode($invoice_info[0]->sale_price_excl,true);
                            $discountarys = json_decode($invoice_info[0]->discount,true);
                            $sum_excl = json_decode($invoice_info[0]->sum_excl,true);
                            $price_list = json_decode($invoice_info[0]->price_list,true);
                            //$art_idarys = json_decode($invoice_info[0]->art_id,true);
                            //var_dump( $art_quantityarys);exit;
                        ...
                        <div class="col-sm-12" style="margin-top:30px">
                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" style="font-size:20px;" placeholder="" style="height:40px;" class="form-control" id="total_sum" name="total_sum" value="<?php echo set_value('total_sum', $invoice_info[0]? $invoice_info[0]->total_sum :''); ?>">
                                    </div>
                        ...
                        <div class="col-md-12" style = "margin-top:30px;">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12 col-lg-3 preview_pdf" style="padding-top:10px !important;">
                                <? $send_id = $invoice_info[0]? $invoice_info[0]->id :''; ?>
                                <a target="_blank" href="<?echo site_url('pdf-export-invoice-preview-new') . '?inv_id=' .$send_id ;  ?>" class="" style="color:white !important; padding-left:47px;">Förhands</a>
                            </div>
