            ...
            <form id="make_offerter_form" name="make_offerter_form" method="post" action="<?php echo site_url('user/pdf_export_only_offerter_edited'); ?>" enctype="multipart/form-data">
                <div class="form-group col-sm-12" style = "margin-bottom: 15px; padding:0;">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="col-xs-12 col-sm-12" style="height:auto;">
                                <div class="col-md-4 col-sm-12">
                                <label for="order_date" rel="tooltip" title="Date">Datum:</label>
                                </div>
                                <div class="col-md-8 col-sm-12 input-group date datetimepicker" id='invoice_date_value'>
                                    <input type='text' id="quote_date" name="quote_date" class="form-control"  style = "height: 40px;"/>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="col-xs-12 col-sm-12" style="height:auto;">
                                ...
                                <div class="col-md-8 col-sm-12 input-group date datetimepicker" id='due_date_value'>
                                    <input type='text' id="valid_date" name="valid_date" class="form-control"  style = "height: 40px;"/>
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar" style = "padding-top: 5px;"></span>
                                    </span>
                                </div>
                ...
                <div class="form-group col-sm-12" style = "margin-bottom: 0px; padding:0;">
                    <div class="col-md-4 col-sm-12">
                        <div class="col-xs-12 col-sm-12" style="height:auto;">
                                ...
                                <div class="col-md-8 col-sm-12 input-group">
                                    <input type="text" placeholder="" style="height:40px;! important" class="form-control" id="your_ref" name="your_ref" value="<?php //echo set_value('id', $model? $model->id :''); ?>">
                                </div>
                                <span style="color:red;"><?php ?></span>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="col-xs-12 col-sm-12" style="height:auto;">
                                <div class="col-md-4 col-sm-12">
                                    <label class="form-label control-label">Våran referens:</label>
                                </div>
                                <div class="col-md-8 col-sm-12 input-group" >
                                    <input type="text" placeholder="" style="height:40px;! important" class="form-control" id="our_ref" name="our_ref" value="<?php //echo set_value('id', $model? $model->id :''); ?>">
                                </div>
                                <span style="color:red;"><?php ?></span>
                        </div>
                    </div>
                ...
                <div class = "col-sm-12" id="add-article-area" style = "min-height: 50px; margin-top:20px">
                    ...
                    <div class="col-sm-12 row" id="head_caption_offerter">
