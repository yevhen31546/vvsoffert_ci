    ...
    <body class="main_body" style="position:relative;height:1200px;">
        ...
        <table style="padding: 10px 5px; border-radius: 3px !important; margin-top:0%;font-family: helvetica;" width="100%">
            <tr>
                ...
                <th width="50%" style="text-align:left; vertical-align: middle; padding: 0px 0px 0px 15px;">
                    <p style="    margin-top: 0px;margin-bottom: 3%; !important; text-transform: uppercase !important; font-size: 24px; color: #000000 !important; font-weight: 700;">Offert</p>
		    <p style="    margin-top: 0px;margin-bottom: 3%; !important; text-transform: uppercase !important; font-size: 20px; color: #000000 !important; font-weight: 700;">Offertnummer &nbsp;&nbsp;&nbsp;&nbsp;<?= !empty($offerter_id) ? $offerter_id + 1200 : ''; ?></p>
                </th>
            </tr>
            <tr style="">
                <th width="50%" style="text-align:left; vertical-align: middle; padding: 0px 0px 0px 15px;">
            ...
            <tr>
                <th width="50%" style="text-align:left; vertical-align: middle; padding: 0px 0px 0px 15px;">
                    <table>
                        ...
                        <tr>
                            <th width="30%" style="text-align:left; vertical-align: middle; padding: 0px 0px 0px 15px;">
                                <p style="    margin-top: 5px;margin-bottom: 1%; !important; font-weight: 300 !important; text-transform: uppercase !important; font-size: 16px;color: #000000 !important; ">Referens </p>
                            </th>
                            <th width="70%" style="text-align:left; vertical-align: middle; padding: 0px 0px 0px 15px;">
        ...
        <table style="padding: 10px 5px; border-radius: 3px !important; margin-top:0%;font-family: helvetica;" width="100%">
            <tr>
                <th width="30%" style="margin-top:10%">
                    <table  style="margin-top: 14%;border: 1px solid #000000; border-radius: 3px !important;font-family: helvetica;" width="100%" height="25%">
                        <thead>
                                    <tr>
                                        <th width="40%"> 
